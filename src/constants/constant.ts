...
export const MARKETPLACE_URL = "/pharmacies/mukminpharmacy";
export const MARKETPLACE_PRODUCT_URL = "/pharmacies/mukminpharmacy/product/:id";
export const MARKETPLACE_CART_URL = "/pharmacies/mukminpharmacy/cart";
export const MARKETPLACE_CHECKOUT_URL = "/pharmacies/mukminpharmacy/checkout";
export const MARKETPLACE_PRESCRIPTION_URL = "/pharmacies/mukminpharmacy/upload-prescription";
export const DOCTOR_SPECIALIST_URL = "/doctor/:slug";
