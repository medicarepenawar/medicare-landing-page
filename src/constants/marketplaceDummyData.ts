...
export const MARKETPLACE_PRODUCT_DETAIL = {
  ...
  variant: "Strip isi 10 Tablet",
  description:
    "Efektif untuk meredakan sakit kepala, nyeri tubuh, dan demam dengan cepat. Paracetamol 650mg memberikan aksi kuat melawan rasa sakit namun tetap lembut di lambung. Cocok untuk orang dewasa dan anak di atas 12 tahun.",
  ...
  stock: 124,
  highlights: ["Pereda nyeri bekerja cepat", "Menurunkan suhu tubuh/demam", "Aman di lambung"],
};
