...
import type { LabAssistantRegisterForm as LabAssistantRegisterFormType } from "../../types";
import labAssistantIcon from "../../assets/img/icon-lab-assistant.png";
import { LAB_ASSISTANT_TERMS_AND_CONDITIONS_URL, REGISTER_URL } from "../../constants/constant";
...
interface LabAssistantRegisterFormProps {
  onSubmit: (data: LabAssistantRegisterFormType) => void;
}

const LabAssistantRegisterForm: React.FC<LabAssistantRegisterFormProps> = ({ onSubmit }) => {
  const navigate = useNavigate();
  const { showError, showWarning } = useToast();
  const [showPassword, setShowPassword] = useState(false);
  const [showConfirmPassword, setShowConfirmPassword] = useState(false);
  const [formData, setFormData] = useState<LabAssistantRegisterFormType>({
    fullName: "",
    email: "",
    phone: "",
    password: "",
      ...
      <div className="w-full max-w-[1200px] min-h-[500px] md:h-auto lg:h-[85vh] bg-white rounded-[24px] md:rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.15)] overflow-hidden">
        <div className="flex flex-col lg:flex-row h-full">
          ...
          <div className="hidden lg:flex lg:w-1/2 px-6 py-8 flex-col items-center justify-center bg-white">
            ...
            {/* Lab Assistant Illustration */}
            <div className="mb-6 xl:mb-8">
              <div className="w-[200px] h-[200px] xl:w-[300px] xl:h-[300px] bg-gradient-to-br from-teal-50 to-blue-50 rounded-full flex items-center justify-center shadow-[0_15px_40px_rgba(0,0,0,0.1)] overflow-hidden">
                <img src={labAssistantIcon} alt="Lab Assistant" className="w-full h-full object-contain scale-90" />
              </div>
            </div>

            <h2 className="text-3xl xl:text-4xl font-bold text-gray-900 mb-4 xl:mb-6">Onsite Lab Assistant</h2>
          ...
          <div className="w-full lg:w-1/2 px-5 sm:px-8 lg:px-10 py-6 sm:py-8 bg-white flex items-center overflow-y-auto">
            <div className="w-full max-w-[450px] mx-auto">
              ...
              <div className="lg:hidden mb-6 text-center">
                ...
                <p className="text-gray-600 text-sm font-medium">Onsite Lab Assistant Registration</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-2 pt-2">
                  ...
                  <label htmlFor="agreementAccepted" className="text-xs text-gray-700 leading-relaxed">
                    ...
                    <a href={LAB_ASSISTANT_TERMS_AND_CONDITIONS_URL} className="text-blue-600 hover:underline font-medium">
                      Terms of Service
                    </a>
                  </label>
                </div>
...
export default LabAssistantRegisterForm;
