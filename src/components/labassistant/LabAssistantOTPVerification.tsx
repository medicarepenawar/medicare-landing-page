...
interface LabAssistantOTPVerificationProps {
  onSubmit: (data: OTPVerification) => void;
  onResend: () => void;
  email: string;
}

const LabAssistantOTPVerification: React.FC<LabAssistantOTPVerificationProps> = ({
  onSubmit,
  onResend,
}) => {
          ...
          <div className="w-full lg:w-1/2 px-5 sm:px-8 lg:px-10 py-6 sm:py-8 bg-white flex items-center">
            <div className="w-full max-w-[450px] mx-auto">
              ...
              <div className="lg:hidden mb-6 text-center">
                ...
                <p className="text-gray-600 text-sm font-medium">Lab Assistant Verification</p>
                <button
                  onClick={handleSelectRole}
                  type="button"
...
export default LabAssistantOTPVerification;
