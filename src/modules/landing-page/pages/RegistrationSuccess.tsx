...
import { VENDOR_REGISTRATION_SUCCESS_URL, DOCTOR_REGISTRATION_SUCCESS_URL } from "../../../constants/constant";
          ...
          {role.toLowerCase() === "nurse" || role.toLowerCase() === "labassistant" || role.toLowerCase() === "therapist" ? (
            ...
            <>
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6 mb-6 mt-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-3">Please Login via Mobile App</h2>
                ...
                <p className="text-blue-600 text-xl font-bold mb-4">Medicare One App</p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                  <a href="#" className="inline-flex items-center gap-2 bg-black text-white px-6 py-3 rounded-xl hover:bg-gray-800 transition-colors">
            ...
            <>
              <p className="text-gray-500 text-base mb-8">You will be redirected to the login page shortly.</p>
