      ...
      <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section className="flex flex-1 flex-col justify-center py-8 lg:py-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg">Select the role that matches your work profile to continue.</p>
          </div>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col items-center justify-between pt-5">
                    ...
                    <div className="mt-6">
                      ...
                      <p className={`mt-2 min-h-[40px] text-sm leading-5 ${isInactive ? "text-slate-400" : "text-slate-500"}`}>{role.helper}</p>
                    </div>
                  </div>
                </button>
              );
          ...
          <div className="mt-8 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                ...
                >
                  {selectedRoleOption ? (
                    <img src={selectedRoleOption.icon} alt="" className={`h-full w-full object-contain ${selectedRoleOption.imageClassName}`} />
                  ) : (
              ...
              <div className="flex flex-col-reverse gap-3 sm:flex-row sm:items-center">
                ...
                <button
                  ...
                  className={`inline-flex h-12 items-center justify-center gap-2 rounded-lg px-6 text-sm font-bold text-white transition ${
                    selectedRole ? "bg-blue-600 shadow-lg shadow-blue-200 hover:bg-blue-700" : "cursor-not-allowed bg-slate-300 text-slate-100"
                  }`}
                >
                  Continue
      ...
      {showMobileLoginModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-2xl">
            ...
            <p className="mt-5 leading-7 text-slate-600">Login for this role is available through the Medicare One mobile app.</p>
