...
const ClinicDetailsCard: React.FC = () => (
  <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
    <div className="flex gap-4">
      <img src={visitClinicImg} alt="Clinic" className="w-24 h-24 rounded-lg object-cover" />
      <div className="flex-1">
        <h3 className="font-bold text-gray-900 text-sm mb-1">
          POLIKLINIK PENAWAR JANAELEKTRIK
          <br />
          SULTAN ISKANDAR
        </h3>
        <p className="text-xs text-gray-600 mb-2">
          Group: KUMPULAN PERUBATAN PENAWAR SDN BHD
          <br />
          Email: janaelektriksipoliklinik@penawar.com
        </p>
        <p className="text-xs text-gray-500">
          JSTEER JANAELEKTRIK SULTAN ISKANDAR RAHAMAN PENJAMAN
          <br />
...
const LoggedInCard: React.FC = () => (
  <div className="bg-white rounded-xl p-6 border border-gray-200">
    ...
    <p className="text-sm font-bold text-gray-900 mb-3">POLIKLINIK PENAWAR JANAELEKTRIK SULTAN ISKANDAR</p>
    <div className="bg-blue-50 rounded-lg p-3 mb-3">
      <p className="text-xs text-blue-800 font-medium">Current Doctor [1] On Duty</p>
    </div>
    <p className="text-sm font-semibold text-gray-900">DR. MOHD KHAIRUL BIN MANSOR</p>
  </div>
);
