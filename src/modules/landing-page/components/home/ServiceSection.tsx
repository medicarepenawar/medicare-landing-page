...
const HERO_ICON_PATHS: Record<string, string> = {
  ...
  "heroicon-o-shopping-bag": "M5 8a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V8zm3 0V6a4 4 0 118 0v2",
  "heroicon-o-calendar-days": "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
};
...
export const ServicesSection: React.FC<ServicesSectionProps> = ({ servicesData }) => {
  const [selectedImage, setSelectedImage] = useState<string | null>(null);
  const services: Service[] = servicesData?.length
    ? servicesData.map((service) => ({
        icon: getIconPath(service.icon),
        title: service.name,
      ...
      {selectedImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            {/* Image */}
            <img src={selectedImage} alt="Service" className="max-w-full max-h-full object-contain" />
          </div>
        </div>
      )}
