...
import TherapistRegisterForm from '../../components/therapist/TherapistRegisterForm';
import TherapistOTPVerification from '../../components/therapist/TherapistOTPVerification';
  ...
  return (
    <>
      ...
      {currentStep === 'register' && (
        <TherapistRegisterForm onSubmit={handleRegisterSubmit} />
      )}

      {/* OTP Verification */}
      {currentStep === 'otp' && registerData && (
        <TherapistOTPVerification
